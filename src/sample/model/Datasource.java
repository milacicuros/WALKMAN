...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Uros\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Error SQLException e2! " + e2.getMessage());
            }
        } finally {
            try {
